...
import { checkIfEmailExists } from "@/app/auth/action";
import { sendForgotPassword } from "@/app/auth/forgotPassword/action";
  ...
  return (
    <div className="w-full h-screen flex flex-col justify-center items-center space-y-10">
      <div className="flex flex-col items-center space-y-8">
        <h2 className="text-3xl">Changer de mot de passe</h2>
        <Form {...form}>
          <form
